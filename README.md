...
| **TYPE_GRAVITY**            | Software or Hardware | Meri silu gravitacije u m/s² koja deluje na uređaj duž sve tri fizičke ose (x, y, z).                                                          | Detekcija pokreta (tresenje, nagib, itd.).|
...
| **TYPE_LINEAR_ACCELERATION**| Software or Hardware | Meri silu ubrzanja u m/s² koja deluje na uređaj duž sve tri fizičke ose (x, y, z), isključujući silu gravitacije.                              | Praćenje ubrzanja duž jedne ose.          |
